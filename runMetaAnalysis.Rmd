...
```{r, echo=FALSE, fig.width=10, fig.height=h[1]}
forest(models[[1]], main=domains[1],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[2]}
forest(models[[2]], main=domains[2],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[3]}
forest(models[[3]], main=domains[3],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[4]}
forest(models[[4]], main=domains[4],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[5]}
forest(models[[5]], main=domains[5],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[6]}
forest(models[[6]], main=domains[6],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[7]}
forest(models[[7]], main=domains[7],
       mlab="Pooled random effect", alim=alim, xlim=xlim, at=at)
```

```{r, echo=FALSE, fig.width=10, fig.height=h[8]}
