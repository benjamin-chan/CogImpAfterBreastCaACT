...
M0 <- rma.mv(yi ~ domain - 1 + ageCentered, vi, data=D, slab=slab)
M1 <- rma.mv(yi ~ domain - 1 + ageCentered, vi, data=D, random = randomEffects, slab=slab)
M2 <- rma.mv(yi ~ ageCentered, vi, data=D, random = randomEffects)
```
